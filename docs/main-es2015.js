...
const routes = [
    {
        path: "",
        loadChildren: () => __webpack_require__.e(/*! import() | features */ "features").then(__webpack_require__.bind(null, /*! ./features */ "./src/app/features/index.ts")).then((m) => m.WorkspaceModule),
    },
];
